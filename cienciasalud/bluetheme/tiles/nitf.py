...
class INitfPrincipal(IListTile):
    """
    """


class NitfPrincipal(ListTile):

    index = ViewPageTemplateFile("templates/nitf_principal.pt")
...
class INitfSecundary(INitfPrincipal):
    pass


class NitfSecundary(NitfPrincipal):
